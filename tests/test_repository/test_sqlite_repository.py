...
DB_FILE = 'database\\test_sqlrepo.db'
FILE_PATH = 'C:\\Users\\Russkin Dmitry\\Downloads\\bookkeeper-master\\'

@pytest.fixture
def create_bd():
    with sqlite3.connect(FILE_PATH+DB_FILE) as con:
        cur = con.cursor()
...
def repo(custom_class, create_bd):
    return SQLiteRepository(db_file=FILE_PATH+DB_FILE, cls=custom_class)
